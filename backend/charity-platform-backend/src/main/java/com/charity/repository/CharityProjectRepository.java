...
public interface CharityProjectRepository extends JpaRepository<CharityProject, Long> {
    ...
    // ===== Paginated overloads =====
    Page<CharityProject> findByStatus(ProjectStatus status, Pageable pageable);
    Page<CharityProject> findByWard(String ward, Pageable pageable);
    Page<CharityProject> findByCategory(String category, Pageable pageable);
}
